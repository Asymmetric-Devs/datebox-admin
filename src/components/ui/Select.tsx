    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <select
          ref={ref}
          className={cn(
            "w-full rounded-xl border border-zinc-300 dark:border-zinc-800 bg-white dark:bg-zinc-900/80 px-3.5 py-2.5 text-sm text-zinc-900 dark:text-zinc-100 shadow-sm transition-all focus:border-zinc-900 dark:focus:border-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-400 disabled:opacity-50",
